const styles = {
    ...
    sectionHeadText:
        " font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px] text-gradient from-purple-to-pink",
    sectionSubText:
        "sm:text-[18px] text-[14px] font-medium uppercase tracking-wider",
};
